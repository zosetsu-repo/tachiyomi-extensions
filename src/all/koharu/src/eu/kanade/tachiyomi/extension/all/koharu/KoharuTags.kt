...
data class Genre(val id: Int, val name: String, val namespace: Int = 0)
data class Artist(val id: Int, val name: String, val namespace: Int = 1)
data class Circle(val id: Int, val name: String, val namespace: Int = 2)
data class Parody(val id: Int, val name: String, val namespace: Int = 3)
data class Male(val id: Int, val name: String, val namespace: Int = 8)
data class Female(val id: Int, val name: String, val namespace: Int = 9)
data class Mixed(val id: Int, val name: String, val namespace: Int = 10)
data class Other(val id: Int, val name: String, val namespace: Int = 12)
